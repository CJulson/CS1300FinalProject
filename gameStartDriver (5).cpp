    ...
    while(testGame.lose == false && testGame.win == false) 
    {
        ...
        if(dungeonExit == true )
        {
            if(testParty.roomsClear == 5) // IF ALL ROOMS CLEARED
            {
                ...
                //Print Out Game Data
                cout << "Number of rooms cleared: " <<  << endl;
                cout << "Gold pieces remaining: " << << endl;
                cout << "Treasure remaining: " << << endl;
                cout << "Number of spaces explored: " << << endl;
                cout << "Number of monsters defeated: " << << endl;
                cout << "Number of turns elapsed: " << << endl;
